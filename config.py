...
def set_template(args):
    if args.dataset_code == None:
        ...
        dataset_code = {'1': 'ml-100k', 'b': 'beauty', 'g': 'games', 'sb2023': 'all_beauty_2023', 's2023':'sports_and_outdoors_2023', 't2023':'toys_and_games_2023', 'b2023':'beauty_and_personal_care_2023'}
        args.dataset_code = dataset_code[input('Input 1 for ml-100k, b for beauty and g for games, sb2023 for all_beauty_2023, s2023 for sport_and_outdoors_2023, t2023 for toys_and_games_2023, b2023 for beauty_and_personal_care_2023: ')]
    ...
    if 'llm' in args.model_code: 
        ...
        batch = 16 if args.dataset_code == 'ml-100k' else 128
